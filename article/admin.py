...
class TagAdmin(admin.ModelAdmin):
    ...
    def article_count(self, obj):
        return obj.article_set.count()  #统计标签数目

class CategoryAdmin(admin.ModelAdmin):
    list_display = ('id', 'title', 'item_count')

    def item_count(self, obj):
        return obj.item_set.count() #有多少个自雷
class ItemAdmin(admin.ModelAdmin):
    list_display = ('title', 'created_date', 'article_category', 'completed')
...
admin.site.register(Category,CategoryAdmin) #注册 定义一个对象，替换前面的对象
